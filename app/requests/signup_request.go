...
type SignupEmailExistRequest struct {
	Email string `json:"email,omitempty" form:"email" valid:"emial"`
}
...
type SignupUsingPhoneRequest struct {
	...
	PasswordConfirm string `json:"password_comfirm,omitempty" valid:"password_confirm"`
}
...
func SignUpUsingPhone(data interface{}, c *gin.Context) map[string][]string {
	...
	errs = validator.ValidatePasswordConfirm(_data.Password, _data.PasswordConfirm, errs)
...
func SignUpUsingEmail(data interface{}, c *gin.Context) map[string][]string {
	...
	errs = validator.ValidatePasswordConfirm(_data.Password, _data.PasswordConfirm, errs)
	//todo::邮件验证码校验 redis.Get
	//errs = validator.ValidateVerifyCode(_data.Email, _data.VerifyCode, errs)
	return errs
