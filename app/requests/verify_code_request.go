...
//verifyCodePhone表单验证
func VerifCodePhone(data interface{}, c *gin.Context) map[string][]string {
	// 1. 定制认证规则
	...
	if ok := captcha.NewCapture().VerifyCaptcha(_data.CaptchaID, _data.CaptchaAnswer); !ok {
